.. meta::
    ...
    :description: Official Careem Pay Merchant API documentation for NodeJS. Learn about payment processing, ADCB integration, Google Maps booking, and regional fintech solutions.
    :keywords: Careem Pay API, NodeJS Merchant Plugin, Fintech UAE, ADCB Integration, Payment Gateway GCC, Ride-Hailing SDK
    :author: Muayed
...
The **Careem Pay Merchant Plugins** repository offers server-side code plugins to simplify integration with the **Careem Pay Merchant API**. Merchants can configure their credentials in an `.env` file and access Careem Pay Merchant APIs with minimal additional code.
...
- **Careem Pay Merchant Onboarding**:
  - A registered merchant account on Careem Pay.
  - Your **Client ID** and **Client Secret** issued by Careem Pay.
